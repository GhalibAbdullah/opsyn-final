---
title: 'Helm'
description: 'Deploy OpSyn on Kubernetes using Helm'
---

This guide walks you through deploying OpSyn on Kubernetes using the official Helm chart.
...
Create a `my-values.yaml` file with your configuration. You can use the [example values file](https://github.com/Z-vren/opsyn-final/blob/main/deploy/activepieces-helm/values.yaml) as a reference.
...
- **`cloud`**: For OpSyn Cloud deployments
...
For platform admin features, see the [Platform Admin](/admin-console/overview) documentation.
