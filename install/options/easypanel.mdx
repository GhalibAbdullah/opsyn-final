---
title: "Easypanel"
description: "Run OpSyn with Easypanel 1-Click Install"
---

Easypanel is a modern server control panel. If you [run Easypanel](https://easypanel.io/docs) on your server, you can deploy OpSyn with 1 click on it.
...
4. Install OpSyn using the dedicated template.
