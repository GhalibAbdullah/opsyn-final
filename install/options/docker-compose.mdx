...
To get up and running quickly with OpSyn, we will use Docker Compose. Follow these steps:

## Prerequisites

You need to have [Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git) and [Docker](https://docs.docker.com/get-docker/) installed on your machine in order to set up OpSyn via Docker Compose.

## Installing

**1. Clone the OpSyn repository.**

Use the command line to clone the OpSyn repository:
...
To upgrade to new versions, which are installed using docker compose, perform the following steps. First, open a terminal in the repository directory and run the following commands.
