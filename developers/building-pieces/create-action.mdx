...
To make the action readable by OpSyn, add it to the array of actions in the piece definition.
...
To test the action, use the flow builder in OpSyn. It should function as shown in the screenshot.
