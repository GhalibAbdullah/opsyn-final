...
To make the trigger readable by OpSyn, add it to the array of triggers in the piece definition.
...
To test the trigger, use the load sample data from flow builder in OpSyn. It should function as shown in the screenshot.
