...
icon: 'clock'
description: "Learn how flow versioning works in OpSyn"
---

OpSyn keeps track of all published flows and their versions. Here’s how it works:
...
4. If you try to edit a published flow, OpSyn will create a new **draft** if there is none and copy the **published** version to the new version.
